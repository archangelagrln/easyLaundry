...
<?php 
  ...
  <div class="text-welcome">Create Account</div>
  ...
  <div class="input-group">
    ...
    <div class="input-inner">
      <span class="icon-left">
        <!-- Email Icon (Envelope) -->
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 28 29" fill="none">
            <path d="M8.16663 10.4167L11.599 12.446C13.6 13.6292 14.3999 13.6292 16.401 12.446L19.8333 10.4167" stroke="#616161" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M2.35177 16.2215C2.42804 19.7979 2.46617 21.5862 3.78582 22.9108C5.10547 24.2356 6.9421 24.2816 10.6153 24.3739C12.8792 24.4309 15.1209 24.4309 17.3848 24.3739C21.058 24.2816 22.8946 24.2356 24.2142 22.9108C25.5339 21.5862 25.5721 19.7979 25.6483 16.2215C25.6729 15.0715 25.6729 13.9283 25.6483 12.7784C25.5721 9.20192 25.5339 7.41369 24.2142 6.08902C22.8946 4.76435 21.058 4.71821 17.3848 4.62592C15.1209 4.56903 12.8792 4.56903 10.6153 4.62591C6.9421 4.71819 5.10547 4.76433 3.78582 6.08901C2.46617 7.41368 2.42803 9.20191 2.35177 12.7783C2.32724 13.9283 2.32724 15.0715 2.35177 16.2215Z" stroke="#616161" stroke-width="1.75" stroke-linejoin="round"/>
        </svg>
      </span>
  ...
  <div class="input-group">
    ...
    <div class="input-inner">
      <span class="icon-left">
        <!-- Phone Icon -->
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 28 29" fill="none">
            <path d="M5.83337 10.9999C5.83337 7.15012 5.83337 5.22521 7.02936 4.02924C8.22533 2.83325 10.1502 2.83325 14 2.83325C17.8498 2.83325 19.7747 2.83325 20.9708 4.02924C22.1667 5.22521 22.1667 7.15012 22.1667 10.9999V17.9999C22.1667 21.8497 22.1667 23.7746 20.9708 24.9706C19.7747 26.1666 17.8498 26.1666 14 26.1666C10.1502 26.1666 8.22533 26.1666 7.02936 24.9706C5.83337 23.7746 5.83337 21.8497 5.83337 17.9999V10.9999Z" stroke="#616161" stroke-width="1.75" stroke-linecap="round"/>
            <path d="M12.8334 22.6667H15.1667" stroke="#616161" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M10.5 2.83325L10.6038 3.45628C10.8289 4.80642 10.9414 5.4815 11.4044 5.8923C11.8874 6.32082 12.5721 6.33325 14 6.33325C15.4279 6.33325 16.1126 6.32082 16.5956 5.8923C17.0587 5.4815 17.1711 4.80642 17.3962 3.45628L17.5 2.83325" stroke="#616161" stroke-width="1.75" stroke-linejoin="round"/>
        </svg>
      </span>
      <input type="tel" id="phone" name="no_telpon" placeholder="Enter your phone number" required />
    </div>
  </div>
  ...
  <p style="margin-top: 15px; font-family: 'rubik'; font-size: 14px; color: #555;">
    Already have an account?
    <a href="login.php" style="color: #21B7E2; text-decoration: none; font-weight: 500;">Login</a>
  </p>
</div>
</form>
